...
| GET | `/api/agents/:id/export/:format` | Export agent config (cloudflare, chatgpt, claude, api) |
...
- `ExportDialog` - Export agents to Cloudflare Agents, ChatGPT, Claude, generic API, or generate embeddable widget code
